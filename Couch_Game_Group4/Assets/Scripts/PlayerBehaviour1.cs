...
public class PlayerBehaviour1 : MonoBehaviour
{
    ...
    void HandleInput()
    {
        _horizontalInput = Input.GetAxis("HorizontalP3");
        _verticalInput = Input.GetAxis("VerticalP3");
    }
    //Move Methods
    void Movement()
    {
    ...
    void Jump()
    {
        if (Input.GetButtonDown("JumpP3") && _isGrounded)
        {
    ...
    void Dash()
    {
        if (Input.GetButtonDown("DashP3") && _dash == false)
        {
